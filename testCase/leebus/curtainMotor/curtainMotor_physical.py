#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2019/7/29 下午6:43
# @Author  : Chenzd
# @Site    : 窗帘电机--物理设备编辑
# @File    : curtainMotor_physical.py
# @Software: PyCharm
# @company:  LEELEN
import unittest
...
logger = Logger(logger='testCase.leebus.curtainMotor.curtainMotor_physical').getlog()
class curtainMotor_physical(unittest.TestCase):
    '''窗帘电机--物理设备编辑'''
    @classmethod
    def setUpClass(cls):
        print('窗帘电机--物理设备编辑冒烟')
    ...
    def test_curtainMotor_physical(self):
